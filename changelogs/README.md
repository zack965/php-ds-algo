...
|---|---|---|
| [v0.5.0](v0.5.0.md) | 2026-09-12 | `CircularLinkedList`, `Deque`, `BinaryTree`/`BinarySearchTree`, heap/bucket sort, KMP substring search — plus three tree logic bugs and a Queue capacity redesign. |
...
Unreleased: nothing on `main` past `v0.5.0` as of 2026-09-12.
